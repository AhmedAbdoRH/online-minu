            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
                    {features.map((feature, index) => (
                        <div key={index} className="group p-4 sm:p-6 md:p-8 rounded-2xl bg-card border border-border/50 hover:border-[#ffb800]/20 hover:shadow-lg transition-all duration-300">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-gradient-to-br from-primary/10 to-[#ffb800]/5 flex items-center justify-center text-primary mb-3 sm:mb-4 md:mb-6 group-hover:scale-110 transition-transform">
